      ...
      {players && players.length >= 3 && (
        <div className="flex items-end justify-center gap-3 py-4">
          ...
          <div className="flex flex-col items-center gap-1">
            <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center font-bold text-slate-300">
              {players[1].username[0].toUpperCase()}
            </div>
            <p className="text-xs font-bold text-slate-300 max-w-[70px] truncate text-center">{players[1].username}</p>
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <p className="text-xs font-bold text-slate-300 max-w-[70px] truncate text-center">{players[2].username}</p>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className={`text-sm font-bold truncate ${isMe ? 'text-indigo-700' : 'text-white'}`}>
                ...
                <div className="flex flex-col items-end gap-1">
                  <RankBadge tier={tier} />
                  <span className="text-xs font-bold text-slate-300">{player.elo_rating}</span>
                </div>
              </div>
            )
          })}
